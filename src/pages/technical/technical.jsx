  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        {isMobile === false && (
          <Parallax filter image={require('../../assets/img/technical-background.png')}>
            <div className={classes.container}>
              <GridContainer>
                <GridItem xs={12} sm={12} md={6}>
                  <h1 className={classes.title}>Powerful interaction.</h1>
                  <h4>Combining The best of digital, analog, AI, cloud and quantum technologies.</h4>
                  <br />
                </GridItem>
              </GridContainer>
            </div>
        ...
        {isMobile === true && (
          <Parallax filter image={require('../../assets/img/mobile-tech-background.png')}>
            <div className={classes.container}>
              <GridContainer>
                <GridItem xs={12} sm={12} md={6}>
                  <h1 className={classes.title}>Powerful interaction.</h1>
