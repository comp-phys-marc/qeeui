      ...
      <div className={classes.section}>
        ...
        <GridContainer>
          ...
          <GridItem xs={12} sm={6} md={6}>
            ...
            <h5 className={classes.explanation}>
              One result that is provided after an experiment is a set of
              calculations like the output below. A number of such calculations
              may be produced; one for each emulation node that attempted the
              problem. Since results are sometimes based on the measurement of
              an emulated superposition, the set of calculations from any one
        ...
        <GridContainer>
          ...
          <GridItem xs={12} sm={12} md={6}>
            ...
            <h5 className={classes.explanation}>
              Get into the math. We are doing linear algebra under the hood, and
              you are a certified mechanic. Just change a setting to have a look
              for yourself.
            </h5>
          </GridItem>
        </GridContainer>
