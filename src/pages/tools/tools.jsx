  ...
  render() {
    ...
    return (
      <div className={classes.content}>
        ...
        />
        {isMobile === false && (
          <Parallax filter image={require('../../assets/img/tools-background.png')}>
            <div className={classes.container}>
              <GridContainer>
                <GridItem xs={12} sm={12} md={6}>
                  <h1 className={classes.title}>Quantum Compuing Tools We've Developed.</h1>
        ...
        {isMobile === true && (
          <Parallax filter image={require('../../assets/img/mobile-tools-background.png')}>
            <div className={classes.container}>
              <GridContainer>
                <GridItem xs={12} sm={12} md={6}>
                  <h1 className={classes.title}>Quantum Compuing Tools We've Developed.</h1>
